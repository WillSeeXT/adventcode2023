...
fn main() {
    ...
    // let mut five_of_a_kind_joker: Vec<Hand> = Vec::new();
    // let mut four_of_a_kind_joker: Vec<Hand> = Vec::new();
    // let mut full_house_joker: Vec<Hand> = Vec::new();
    // let mut tree_of_a_kind_joker: Vec<Hand> = Vec::new();
    // let mut two_pairs_joker: Vec<Hand> = Vec::new();
    // let mut one_pair_joker: Vec<Hand> = Vec::new();
    // let mut high_card_joker: Vec<Hand> = Vec::new();
        ...
        if let Ok(hand_str) = line {
            ...
            for card in current_hand_vec {
                match card {
                    ...
                    'J' => hand.cards.push(joker_val), // Joker
    ...
    for hand in hands {
        ...
        if hand.cards.contains(&joker_val) {

            let joker_count = hand.cards.iter().filter(|&&num| num == joker_val).count();
